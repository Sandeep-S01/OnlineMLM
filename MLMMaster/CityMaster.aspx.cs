...
public partial class MLMMaster_CityMaster : System.Web.UI.Page
{
    int returnvalue = 0;
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            Bind();
            UIServices.fill_ComboBox(ddlstate, "select * from tblState where Status='UnBlock' Order by State", "State", "ID", "Select State");
        }
    }
    ...
    public void Bind()
    {
        try
        {
            ...
            dsWarehousemst = SQLHelper.ExecuteDataset(Security.ConnectionString(), CommandType.Text, "Select * from tblCity");
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string State = ddlstate.SelectedItem.Value.ToString().Trim();
            ...
            if(btnsubmit.Text == "Submit")
            {
                ...
                SQLHelper.ExecuteScalar(Security.ConnectionString(), CommandType.StoredProcedure, "sp_City", sqlparm.ToArray());
        ...
        try
        {
            ...
            if (CommandName == "EditRow")
            {
                ...
                if (dspatmst.Tables[0].Rows.Count > 0)
                {
                    ...
                    txtcity.Text = dspatmst.Tables[0].Rows[0]["City"].ToString();
                    ddlstate.Text = dspatmst.Tables[0].Rows[0]["State"].ToString();
            ...
            if (CommandName == "UnBlock")
            {
                ...
                SQLHelper.ExecuteScalar(Security.ConnectionString(), CommandType.StoredProcedure, "sp_cityblkunblk", parameterss.ToArray());
                Bind();
