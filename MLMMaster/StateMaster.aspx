<%@ Page Language="C#" AutoEventWireup="true" CodeFile="StateMaster.aspx.cs" Inherits="MLMMaster_StateMaster" %>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <asp:TextBox runat="server" ID="txtstate" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RFV1" runat="server" Display="Dynamic" ControlToValidate="txtstate"
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" Display="Dynamic"
                                            CssClass=" font-weight-bold" Font-Size="Smaller" ForeColor="Red" ControlToValidate="txtstate" ErrorMessage="InValidFormat" ValidationExpression="^[a-zA-Z_\s]{2,}$">
                                ...
                                <div class="row ">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlcountry" CssClass="form-control"></asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RFV2" runat="server" Display="Dynamic" ControlToValidate="ddlcountry"
