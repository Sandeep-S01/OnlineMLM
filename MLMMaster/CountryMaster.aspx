<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CountryMaster.aspx.cs" Inherits="MLMMaster_CountryMaster" %>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <asp:TextBox runat="server" ID="txtcountry" CssClass="form-control"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RFV1" runat="server" Display="Dynamic" ControlToValidate="txtcountry"
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" Display="Dynamic"
                                            CssClass=" font-weight-bold" Font-Size="Smaller" ForeColor="Red" ControlToValidate="txtcountry" ErrorMessage="InValidFormat" ValidationExpression="^[a-zA-Z_\s]{2,}$">
